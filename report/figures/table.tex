...
\begin{table}[h]
    ...
    \begin{tabular}{lcc}
    \hline
    \textbf{Metric} & \textbf{Mean} & \textbf{SD} \\
    \hline
    Final Rabbits & 84.84 & 60.62 \\
    Final Foxes   & 19.69 & 9.85 \\
    \hline
    \end{tabular}
    \caption{Summary statistics for final populations of rabbits and foxes across 100 simulations each with 1000 iterations.}
    \label{tab:final-populations_baseline}
    \end{table}
